	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIsland") then
			for r, v in pairs(game.workspace.Map.MysticIsland:GetChildren()) do
				if v:IsA("MeshPart") and v.MeshId == "rbxassetid://17269655811" then
					return v
				end
			end
		end
...
local Window = OrionLib:MakeWindow({Name = "Quang Dung Hub", HidePremium = false, IntroText = "Quang Dung Hub", SaveConfig = true, ConfigFolder = "FF hub Script"})
----------Tab-----------------------
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Dungg Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://133211668596913",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "Dungg Hub(Noitification)",
